...
public class MemoryServiceTest
{
    ...
    public void BaseTest()
    {
        ...
        var var1res = memoryService.Get(var1);
        var var2res = memoryService.Get(var2);
        var let1res = memoryService.Get(let1);
        var let2res = memoryService.Get(let2);
        var let3res = memoryService.Get(let3);
        var let4res = memoryService.Get(let4);
        var fn1res = memoryService.Get(fn1);
        var fn2res = memoryService.Get(fn2);
        var fn3res = memoryService.Get(fn3);
        var fn4res = memoryService.Get(fn4);
    ...
    public void Fibonacci5ElementTest()
    {
        ...
        var t = memoryService.Get(fin4);
        // Assert
        Assert.That((int)memoryService.Get(fin4), Is.EqualTo(5));
    }
    ...
    public void AddVariable_Should_AddVariableWithValue_When_FirstVariableIsNumber()
    {
        ...
        // Assert
        Assert.That(memoryService.Get(new Command { Identifier = identifier }), Is.EqualTo(value));
    }
    ...
    public void AddVariable_Should_AddVariableWithReferencedValue_When_FirstVariableIsIdentifier()
    {
        ...
        // Assert
        Assert.That(memoryService.Get(new Command { Identifier = identifier2 }), Is.EqualTo(value));
    }
